...
public class UserUtils {
	...
	public static final String CACHE_SYSMENU_LIST = "sysmenuList";
	...
	public static void clearCache(){
		...
		removeCache(CACHE_PRODUCT_LIST);
	...
	public static List<SysMenu> getSysMenuList(){
		@SuppressWarnings("unchecked")
		List<SysMenu> sysmenuList = (List<SysMenu>)getCache(CACHE_SYSMENU_LIST);
		if (sysmenuList == null){
			User user = getUser();
			if (user.isAdmin()){
				sysmenuList = SysmenuDao.findAllList(new SysMenu());
			}else{
				SysMenu m = new SysMenu();
				m.setUserId(user.getId());
				sysmenuList = SysmenuDao.findByUserId(m);
			}
			putCache(CACHE_SYSMENU_LIST, sysmenuList);
		}
		return sysmenuList;
	}
	...
	public static List<Product> getProductAllList(){
		@SuppressWarnings("unchecked")
		List<Product> productList = (List<Product>)getCache(CACHE_PRODUCT_LIST);
		if (productList == null){
			productList = productDao.findAllList(new Product());
		}
		return productList;
	}
