...
public class SystemAuthorizingRealm extends AuthorizingRealm {
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authcToken) {
        ...
        if (user != null) {
            ...
            return new SimpleAuthenticationInfo(new Principal(user, token.isMobileLogin()), user.getPassword()
    ...
    protected AuthorizationInfo doGetAuthorizationInfo(PrincipalCollection principals) {
        ...
        // 加入session
        // Session sessionAdd = UserUtils.getSession();
        // User userAdd =
        // getSystemService().getUserByLoginName(principal.getLoginName());
        // String username = userAdd.getLoginName();
        // sessionAdd.setAttribute(username, username);
        // 获取当前已登录的用户
